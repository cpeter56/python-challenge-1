        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    cust_item=menu_items[menu_selection]

                    # Ask the customer for the quantity of the menu item
                    quantity=input("How many you want? If you select a non digit it will default to 1. ")
                    #i=0
                ...
                else: print(f"{menu_selection} was not in menu items.")

                # Tell the customer they didn't select a menu option
            else:
                print(f"{menu_selection} is not an integer.")
...
# i=1
# for value in order_list[i].values():
for order in order_list:
...
#     quantity=order_list[2][value]
    ...
    print(f"{item_name}{item_spaces} | ${price}{item_spaces2}| {quantity}")
    #i+=1
